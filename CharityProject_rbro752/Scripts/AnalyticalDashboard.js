$(document).ready(function () {
    $.ajax({
        ...
        url: '../WebForms/AnalyticalDashboard.aspx/GetDashboardData', // Pagename should be exactly same as your page name Analytical Dashboard in our case. GetDashboardData web method name should match with the web method name on AnalyticalDashboard.aspx.cs
        data: '{}',
        success:
            function (response) {
